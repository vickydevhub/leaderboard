						...
						<div class="row">
							<div class="col-sm-6">
								<div class="inputBox">
									...
									<input type="text" name="email" class="@error('name') is-invalid @enderror input">
								</div>
                                @error('email')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
							...
							<div class="col-sm-6">
								<div class="inputBox">
									...
									<input type="text" name="contact_number" class="@error('name') is-invalid @enderror input">
								</div>
